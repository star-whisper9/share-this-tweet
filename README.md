...
开发版正在尝试 **FFmpeg 动态拼图与视频画框**：包含 GIF／视频的拼图输出 MP4，动态媒体也可选择上框或下框。首版限制为 30 秒、合计 64 MiB、最高 1280 × 720 媒体画面与 24 fps，支持进度与取消。此功能尚未发布，手机性能仍需实测，规则及验证方法见[动态处理说明](docs/video-processing.md)。卡片仍保持静态。
